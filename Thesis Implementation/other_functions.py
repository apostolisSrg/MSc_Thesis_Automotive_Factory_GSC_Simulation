...
def save_to_txt(filename, number_of_simulations, simulation_results_automobile_1, simulation_results_automobile_2,
...
def automobile_statistics(filename, number_of_simulations, simulation_results_automobile_1,
