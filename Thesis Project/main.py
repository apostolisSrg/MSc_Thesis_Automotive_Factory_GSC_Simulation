...
def main():
    ...
    save_to_txt("simulation-results.txt", simulations, simulation_results_automobile_1, simulation_results_automobile_2,
                simulation_results_automobile_3, simulation_results_automobile_4)
    automobile_statistics("statistics.txt", simulations, simulation_results_automobile_1,
                          simulation_results_automobile_2, simulation_results_automobile_3,
                          simulation_results_automobile_4)
    print("\nSuccessful Process!")
    print("\nThe results of simulations are saved to file 'simulation-results.txt'.\n"
